            ...
            <div className='bg-[#5D9C42] p-2 flex'>
                ...
                <div className="flex h-12 items-center w-full m-1.5 ">
                    ...
                    <div className="flex w-auto ml-auto gap-4 mr-12 text-4xl text-white">
                        ...
                        <a href="https://x.com/?lang=es" target="_blank"><i className="ri-twitter-fill inline-block  transition-all duration-200 hover:-translate-x-1 hover:scale-110 hover:text-[#484848]"></i></a>
